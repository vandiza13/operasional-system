...
import { Search, Wrench, IdCard, Smartphone, Mail, Edit2, Key } from 'lucide-react';
          ...
          <div key={tech.id} className="bg-slate-800/50 p-5 rounded-2xl border border-slate-700/50 shadow-lg hover:shadow-purple-900/20 hover:border-purple-500/30 transition-all group flex flex-col justify-between backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="mt-5 pt-4 border-t border-slate-700/50 space-y-2 relative z-10">
              <div className="flex items-center text-xs font-semibold text-slate-400 gap-2">
                <span className="text-slate-500"><IdCard className="w-4 h-4" /></span> {tech.nik || 'Belum ada NIK'}
              </div>
              <div className="flex items-center text-xs font-semibold text-slate-400 gap-2">
                <span className="text-slate-500"><Smartphone className="w-4 h-4" /></span> {tech.phone || 'Belum ada No. HP'}
              </div>
              <div className="flex items-center text-xs font-semibold text-slate-400 gap-2">
                <span className="text-slate-500"><Mail className="w-4 h-4" /></span> {tech.email}
              </div>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-slate-700/50 flex gap-2 relative z-10">
              ...
              <button
                ...
                className="flex-1 py-2 rounded-lg text-xs font-bold bg-indigo-500/10 text-indigo-400 hover:bg-indigo-500/20 border border-indigo-500/20 transition-all flex items-center justify-center"
              >
              ...
              <button
                ...
                className="flex-1 py-2 rounded-lg text-xs font-bold bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 border border-amber-500/20 transition-all flex items-center justify-center"
